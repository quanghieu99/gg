...
const productDetails = [{
    ...
    qty: 25,
    heading: "Máy tính tiếp theo của bạn không phải là máy tính",
    des: "Đó là một mảnh thủy tinh kỳ diệu. Nó nhanh đến mức hầu hết các máy tính xách tay PC không thể theo kịp. Và bạn có thể sử dụng nó với cảm ứng, bút chì, bàn phím và giờ là bàn di chuột. Đó là iPad Pro mới."
}]
    , cartDetails = [];
